function addQty(){
    // Add elements here
    var qtyDivId = document.getElementById("record-purchase-qty-div");

    // Add qty input field - element
    var qtyBtnId = document.getElementById("record-purchase-qty-btn");

    // If button exists, replace "record-purchase-qty-btn" with (1) label, (2) input field, (3) remove qty btn
    if(qtyBtnId){
        qtyBtnId.remove()
        ...
        qtyRemove.setAttribute('id', 'record-purchase-qty-remove-btn');
        ...
        // If does not exist, replace (1) label, (2) input field, (3) remove qty btn with "record-purchase-qty-btn"
        var qtyLbl = document.getElementById("discard-qty-label");
        var qtyInput = document.getElementById("discard-qty-input-field");
        var qtyRemove = document.getElementById("record-purchase-qty-remove-btn");
        ...
        qtyAddBtn.setAttribute('id', 'record-purchase-qty-btn');
        ...
        // id="record-purchase-qty-btn" class="btn btn-success" onclick="addQty()" style="color: white; width: 100%;"
    }
}